...
const About = () => {
    return (
        <div className="container " >
            ...
            <h1 className="Box">  Hello, <br></br> <br></br>I'm a passionate  Web developer , everyday trying to learn something new and exsitng things so that i can contribute somthing to my country and people. </h1> 
            <br></br>
